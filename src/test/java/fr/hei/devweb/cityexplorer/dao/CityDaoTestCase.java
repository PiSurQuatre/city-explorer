...
public class CityDaoTestCase extends AbstractDaoTestCase {
	...
	public void insertDataSet(Statement statement) throws Exception {
		statement.executeUpdate("INSERT INTO city(id, name, summary, likes, dislikes, country, deleted) VALUES(1, 'City 1', 'Summary 1', 1, 2, 'FRANCE', false)");
		statement.executeUpdate("INSERT INTO city(id, name, summary, likes, dislikes, country, deleted) VALUES(2, 'City 2', 'Summary 2', 3, 4, 'UK', true)");
		statement.executeUpdate("INSERT INTO city(id, name, summary, likes, dislikes, country, deleted) VALUES(3, 'City 3', 'Summary 3', 5, 6, 'FRANCE', false)");
	}
